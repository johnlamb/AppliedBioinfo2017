...
def _validate_input(inputfile, outputfile):
    ...
    if isinstance(inputfile, basestring):
        ...
        # os.system('vmtouch -qt {} & >/dev/null 2>/dev/null'.
        # format(inputfile))
        ...
        raise ValueError('inputfile should be a file name or a'
                         'file handler, got {} instead.'.
                         format(type(inputfile)))
...
def parse_a3m(inputfile, outputfile):
    input_, close_input, output, close_output =\
            _validate_input(inputfile, outputfile)
    ...
    try:
        ...
        print(""" Run as:
                ...
                Valid conv_types:
                    ...
                    """)
    if conv_type == 'a3m':
        parse_a3m(infile, outfile)
    elif conv_type == 'aln':
        parse_aln(infile, outfile)
    elif conv_type == 'fasta':
        parse_fasta(infile, outfile)
    else:
        print(""" Run as:
                conv_type infile outfile
